...
BEGIN
{
  ...
  $postmaster        = 'postmaster@crocodilecreek.com';
  @referers          = qw(crocodilecreek.com 64.91.254.193);
  @allow_mail_to     = ();
  @recipients        = ();
  %recipient_alias   = (
    'prod' => 'cccatalog@netfriends.com',
    'test' => 'michaelk@netfriends.net,mauricio@netfriends.net',
  );
...
=head1 SYNOPSYS
  ...
  my $mailer = CGI::NMS::Mailer::SMTP->new('durham.crocodilecreek.com');
